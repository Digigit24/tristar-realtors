class spaciazSwiperBase extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
    ...
    customSwiperSettings() {
        return this.getSettings("customOptions") || {}
    }
    onElementChange(e) {
        var t;
    ...
    async onInit() {
        ...
        if (this.elements.$swiperContainer.length && !(this.elements.$slides.length < 2)) {
            ...
            var t = Object.assign({}, this.getSwiperSettings(), this.customSwiperSettings());
            this.swiper = await new s(this.elements.$swiperContainer, t), this.elements.$swiperContainer.trigger("swiperInit"), this.elements.$swiperContainer.data("swiper", this.swiper), "yes" === e.pause_on_hover && this.togglePauseOnHover(!0)
        }
    }
